...
public class TestIsland {
    ...
    public void testadditionofBears(){
        ...
        Assertions.assertEquals(expected,bears);
    }
    @Test
    public void testeat(){
        try {
            ...
            for (Animal animal : animals) {
                if (animal instanceof Rabbit) {
                    Assertions.assertEquals("Wolf ate rabbit","Wolf ate rabbit");
                }
                else if (animal instanceof Deer) {
                    Assertions.assertEquals("Wolf ate deer","Wolf ate deer");
                }
                else if (animal instanceof Horse) {
                    Assertions.assertEquals("Wolf ate horse","Wolf ate horse");
                }
                else if (animal instanceof Mouse) {
                    Assertions.assertEquals("Wolf ate mouse","Wolf ate mouse");
                }
                else if (animal instanceof Goat) {
                    Assertions.assertEquals("Wolf ate goat","Wolf ate goat");
                }
                else if (animal instanceof Sheep) {
                    Assertions.assertEquals("Wolf ate sheep","Wolf ate sheep");
                }
                else if (animal instanceof Hog) {
                    Assertions.assertEquals("Wolf ate hog","Wolf ate hog");
                }
                else if (animal instanceof Bull) {
                    Assertions.assertEquals("Wolf ate hog","Wolf ate hog");
                }
                else if (animal instanceof Duck) {
                    Assertions.assertEquals("Wolf ate duck","Wolf ate duck");
                }
            }
        }catch (Exception e) {
    ...
    public void testmove(){
        ...
        Assertions.assertNotNull(island.getCell(5,5).getAnimals());
}
}
